...
try:
    ...
    print("ImportError: package paho-mqtt must be installed.\n\tpip install paho-mqtt\nMore info: https://pypi.python.org/pypi/paho-mqtt/1.3.0#installation")
    import sys
    sys.exit()

mqtt_client = object()
mac_address = "02:00:00:%02x:%02x:%02x" % (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))
print "Using mac_address:  {}".format(mac_address)
